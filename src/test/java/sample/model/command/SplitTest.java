...
public class SplitTest {
    ...
    public void test_calcBlockSize_div2() {
        ...
        assertThat(sut.calcBlockSize(0, div), is(0)); // 0 0
        assertThat(sut.calcBlockSize(1, div), is(1)); // 1 0
        assertThat(sut.calcBlockSize(2, div), is(1)); // 1 1
        assertThat(sut.calcBlockSize(3, div), is(2)); // 2 1
        assertThat(sut.calcBlockSize(4, div), is(2)); // 2 2
        assertThat(sut.calcBlockSize(5, div), is(3)); // 3 2

        assertThat(sut.calcBlockSize(1999, div), is(1000));
        assertThat(sut.calcBlockSize(2000, div), is(1000));
        assertThat(sut.calcBlockSize(2001, div), is(1001));
    }
    ...
    public void test_calcBlockSize_div3() {
        ...
        assertThat(sut.calcBlockSize(0, div), is(0)); // 0 0 0
        assertThat(sut.calcBlockSize(1, div), is(1)); // 1 0 0
        assertThat(sut.calcBlockSize(2, div), is(1)); // 1 1 0
        assertThat(sut.calcBlockSize(3, div), is(1)); // 1 1 1
        assertThat(sut.calcBlockSize(4, div), is(2)); // 2 2 0
        assertThat(sut.calcBlockSize(5, div), is(2)); // 2 2 1
        assertThat(sut.calcBlockSize(6, div), is(2)); // 2 2 2
        assertThat(sut.calcBlockSize(7, div), is(3)); // 3 3 1

        assertThat(sut.calcBlockSize(2999, div), is(1000));
        assertThat(sut.calcBlockSize(3000, div), is(1000));
        assertThat(sut.calcBlockSize(3001, div), is(1001));
    }
